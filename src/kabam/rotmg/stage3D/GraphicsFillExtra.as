...
public class GraphicsFillExtra
{
    ...
    public static const poolSize:int = 2000;
    ...
    private static const DEFAULT_CT:ColorTransform = new ColorTransform();
    ...
    public static function getColorTransform(_arg_1:BitmapData):ColorTransform
    {
        ...
        if ((_arg_1 in colorTransforms))
        {
            ...
            colorTransforms[_arg_1] = DEFAULT_CT;
        }
        else
        {
            _local_2 = DEFAULT_CT;
    ...
    public static function setVertexBuffer(_arg_1:GraphicsBitmapFill, _arg_2:Vector.<Number>):void
    {
        ...
        _local_3.GetContext3D().setVertexBufferAt(0, _local_4, 0, "float3");
        _local_3.GetContext3D().setVertexBufferAt(1, _local_4, 3, "float2");
