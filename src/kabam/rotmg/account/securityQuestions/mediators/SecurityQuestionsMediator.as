...
public class SecurityQuestionsMediator extends Mediator {
    ...
    override public function initialize():void {
        this.view.leftButton_.addEventListener(MouseEvent.CLICK, this.onCloseClick);
        this.view.rightButton_.addEventListener(MouseEvent.CLICK, this.onShowConfirmationClick);
        this.infoView.leftButton_.addEventListener(MouseEvent.CLICK, this.onCloseClick);
    ...
    override public function destroy():void {
        ...
        this.view.leftButton_.removeEventListener(MouseEvent.CLICK, this.onCloseClick);
        this.view.rightButton_.removeEventListener(MouseEvent.CLICK, this.onShowConfirmationClick);
        this.infoView.leftButton_.removeEventListener(MouseEvent.CLICK, this.onCloseClick);
