...
public class WebAccountInfoView extends Sprite implements AccountInfoView {
    ...
    private var moreButton:TitleMenuOption;
    ...
    public function get more():Signal {
        return (this._more);
    }
    ...
    private function makeSignals():void {
        this._more = new NativeMappedSignal(this.moreButton, MouseEvent.CLICK);
    ...
    private function makeMoreButton():void {
        this.moreButton = new TitleMenuOption("accounts", FONT_SIZE, false);
        this.moreButton.setAutoSize(TextFieldAutoSize.RIGHT);
    }
