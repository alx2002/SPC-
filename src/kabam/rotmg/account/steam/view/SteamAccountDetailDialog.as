...
public class SteamAccountDetailDialog extends Sprite {
    ...
    public function setInfo(_arg_1:String, _arg_2:String, _arg_3:Boolean):void {
        var _local_4:Frame;
        _local_4 = new Frame(TextKey.DETAIL_DIALOG_TITLE, "", TextKey.STEAM_ACCOUNT_DETAIL_DIALOG_RIGHTBUTTON);
        addChild(_local_4);
        ...
        _local_4.leftButton_.addEventListener("click", this.onSave);
        _local_4.rightButton_.addEventListener(MouseEvent.CLICK, this.onContinue);
    }

    private function onSave(_arg_1:MouseEvent):void
    {
        new FileReference().save(((("These are your steam rotmg login credentials, do not send these to anyone!\r\n\r\nGUID:\r\n" + SteamAccount.USER) + "\r\n\r\nSecret:\r\n") + SteamAccount.PASS), "Steam Credentials (DO NOT SHARE).txt");
    }
