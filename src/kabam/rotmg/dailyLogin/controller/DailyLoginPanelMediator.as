...
public class DailyLoginPanelMediator extends Mediator {
    ...
    override public function initialize():void {
        ...
        if (this.model.initialized) {
            ...
            SPC.STAGE.addEventListener(KeyboardEvent.KEY_DOWN, this.onKeyDown);
        }
        else {
    ...
    override public function destroy():void {
        ...
        SPC.STAGE.removeEventListener(KeyboardEvent.KEY_DOWN, this.onKeyDown);
        super.destroy();
    }

    private function onKeyDown(_arg_1:KeyboardEvent):void {
        if (((_arg_1.keyCode == Parameters.data_.interact) && (SPC.STAGE.focus == null))) {
