...
public class KeyMapper extends BaseOption {
    ...
    public function KeyMapper(_arg_1:String, _arg_2:String, _arg_3:String, _arg_4:Boolean = false, _arg_5:uint = 0xFFFFFF) {
        super(_arg_1, _arg_2, _arg_3);
        desc_.setColor(_arg_5);
        tooltip_.tipText_.setColor(_arg_5);
        this.keyCodeBox_ = new KeyCodeBox(Parameters.data_[paramName_], _arg_5);
