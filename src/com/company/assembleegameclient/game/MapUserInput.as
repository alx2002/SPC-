...
public class MapUserInput {
        ...
        if (Parameters.data_.rightClickOption == "Quest") {
            ...
            if (Parameters.data_.rightClickOption == "Ability") {
                ...
                if (Parameters.data_.rightClickOption == "Camera") {
                    held = true;
                    heldX = SPC.STAGE.mouseX;
                    heldY = SPC.STAGE.mouseY;
    ...
    private function onKeyDown(_arg_1:KeyboardEvent):void {
        ...
        switch (_arg_1.keyCode) {
            ...
            case Parameters.data_.kdbPetrify:
                Parameters.data_.ignorePetrified = (!(Parameters.data_.ignorePetrified));
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.ignorePetrified) ? "Petrify: On" : "Petrify: Off"), ((Parameters.data_.ignorePetrified) ? 0xFF0000 : 0xFF00), 1500);
                break;
            case Parameters.data_.kdbArmorBroken:
                Parameters.data_.ignoreArmorBroken = (!(Parameters.data_.ignoreArmorBroken));
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.ignoreArmorBroken) ? "Armor Broken: On" : "Armor Broken: Off"), ((Parameters.data_.ignoreArmorBroken) ? 0xFF0000 : 0xFF00), 1500);
                break;
            case Parameters.data_.kdbBleeding:
                Parameters.data_.ignoreBleeding = (!(Parameters.data_.ignoreBleeding));
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.ignoreBleeding) ? "Bleeding: On" : "Bleeding: Off"), ((Parameters.data_.ignoreBleeding) ? 0xFF0000 : 0xFF00), 1500);
                break;
            case Parameters.data_.kdbDazed:
                Parameters.data_.ignoreDazed = (!(Parameters.data_.ignoreDazed));
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.ignoreDazed) ? "Dazed: On" : "Dazed: Off"), ((Parameters.data_.ignoreDazed) ? 0xFF0000 : 0xFF00), 1500);
                break;
            case Parameters.data_.kdbParalyzed:
                Parameters.data_.ignoreParalyzed = (!(Parameters.data_.ignoreParalyzed));
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.ignoreParalyzed) ? "Paralyzed: On" : "Paralyzed: Off"), ((Parameters.data_.ignoreParalyzed) ? 0xFF0000 : 0xFF00), 1500);
                break;
            case Parameters.data_.kdbSick:
                Parameters.data_.ignoreSick = (!(Parameters.data_.ignoreSick));
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.ignoreSick) ? "Sick: On" : "Sick: Off"), ((Parameters.data_.ignoreSick) ? 0xFF0000 : 0xFF00), 1500);
                break;
            case Parameters.data_.kdbSlowed:
                Parameters.data_.ignoreSlowed = (!(Parameters.data_.ignoreSlowed));
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.ignoreSlowed) ? "Slowed: On" : "Slowed: Off"), ((Parameters.data_.ignoreSlowed) ? 0xFF0000 : 0xFF00), 1500);
                break;
            case Parameters.data_.kdbStunned:
                Parameters.data_.ignoreStunned = (!(Parameters.data_.ignoreStunned));
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.ignoreStunned) ? "Stunned: On" : "Stunned: Off"), ((Parameters.data_.ignoreStunned) ? 0xFF0000 : 0xFF00), 1500);
                break;
            case Parameters.data_.kdbWeak:
                Parameters.data_.ignoreWeak = (!(Parameters.data_.ignoreWeak));
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.ignoreWeak) ? "Weak: On" : "Weak: Off"), ((Parameters.data_.ignoreWeak) ? 0xFF0000 : 0xFF00), 1500);
                break;
            case Parameters.data_.kdbQuiet:
                Parameters.data_.ignoreQuiet = (!(Parameters.data_.ignoreQuiet));
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.ignoreQuiet) ? "Quiet: On" : "Quiet: Off"), ((Parameters.data_.ignoreQuiet) ? 0xFF0000 : 0xFF00), 1500);
                break;
            case Parameters.data_.kdbPetStasis:
                Parameters.data_.ignorePetStasis = (!(Parameters.data_.ignorePetStasis));
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.ignorePetStasis) ? "Pet Stasis: On" : "Pet Stasis: Off"), ((Parameters.data_.ignorePetStasis) ? 0xFF0000 : 0xFF00), 1500);
                break;
            case Parameters.data_.kdbSilenced:
                Parameters.data_.ignoreSilenced = (!(Parameters.data_.ignoreSilenced));
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.ignoreSilenced) ? "Silence: On" : "Silence: Off"), ((Parameters.data_.ignoreSilenced) ? 0xFF0000 : 0xFF00), 1500);
                break;
            case Parameters.data_.kdbAll:
                Parameters.data_.dbAll = (!(Parameters.data_.dbAll));
                Parameters.data_.ignorePetrified = Parameters.data_.dbAll;
                Parameters.data_.ignoreArmorBroken = Parameters.data_.dbAll;
                Parameters.data_.ignoreBleeding = Parameters.data_.dbAll;
                Parameters.data_.ignoreDazed = Parameters.data_.dbAll;
                Parameters.data_.ignoreParalyzed = Parameters.data_.dbAll;
                Parameters.data_.ignoreSick = Parameters.data_.dbAll;
                Parameters.data_.ignoreSlowed = Parameters.data_.dbAll;
                Parameters.data_.ignoreStunned = Parameters.data_.dbAll;
                Parameters.data_.ignoreWeak = Parameters.data_.dbAll;
                Parameters.data_.ignoreQuiet = Parameters.data_.dbAll;
                Parameters.data_.ignorePetStasis = Parameters.data_.dbAll;
                Parameters.data_.ignoreSilenced = Parameters.data_.dbAll;
                Options.calculateIgnoreBitmask();
                Parameters.save();
                player.textNotification(((Parameters.data_.dbAll) ? "All: On" : "All: Off"), ((Parameters.data_.dbAll) ? 0xFF0000 : 0xFF00));
                break;
            ...
            case Parameters.data_.addMoveRecPoint:
                ...
                break;
            case Parameters.data_.mboxToggle:
                Parameters.data_.multiBox = !Parameters.data_.multiBox;
                player.textNotification(((Parameters.data_.multiBox) ? "Multibox enabled" : "Multibox disabled"), 0xFFFFFF, 2000, false);
                break;
    ...
    public function activatePreset(_arg_1:int, _arg_2:int = -1):void {
        ...
        switch (_arg_1) {
            case 1:
                str = Parameters.data_.dbPre1[0];
                pres = Parameters.data_.dbPre1[1];
                break;
            case 2:
                str = Parameters.data_.dbPre2[0];
                pres = Parameters.data_.dbPre2[1];
                break;
            case 3:
                str = Parameters.data_.dbPre3[0];
                pres = Parameters.data_.dbPre3[1];
                break;
        }
        if (pres == 0) {
            return;
        ...
        while (counter < 11) {
            if ((pres & (1 << counter)) != 0) {
                switch (counter) {
                    case 0:
                        Parameters.data_.ignoreArmorBroken = bool;
                        break;
                    case 1:
                        Parameters.data_.ignoreBleeding = bool;
                        break;
                    case 2:
                        Parameters.data_.ignoreDazed = bool;
                        break;
                    case 3:
                        Parameters.data_.ignoreParalyzed = bool;
                        break;
                    case 4:
                        Parameters.data_.ignoreSick = bool;
                        break;
                    case 5:
                        Parameters.data_.ignoreSlowed = bool;
                        break;
                    case 6:
                        Parameters.data_.ignoreStunned = bool;
                        break;
                    case 7:
                        Parameters.data_.ignoreWeak = bool;
                        break;
                    case 8:
                        Parameters.data_.ignoreQuiet = bool;
                        break;
                    case 9:
                        Parameters.data_.ignorePetStasis = bool;
                        break;
                    case 10:
                        Parameters.data_.ignorePetrified = bool;
                        break;
                    case 11:
                        Parameters.data_.ignoreSilenced = bool;
                        break;
                }
            }
            counter++;
        ...
        Parameters.save();
        if (_arg_2 != 0) {
            this.gs_.map.player_.textNotification(((bool) ? (str + ": On") : (str + ": Off")), ((bool) ? 0xFF0000 : 0xFF00), 1500);
        }
    }
