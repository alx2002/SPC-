...
public class ConditionEffect {
    ...
    public static const PETRIFIED_IMMUNE_BIT:uint = (1 << (PETRIFIED_IMMUNE - NEW_CON_THRESHOLD));
    public static const PET_EFFECT_ICON_BIT:uint = (1 << (PET_EFFECT_ICON - NEW_CON_THRESHOLD));
    public static const CURSE_BIT:uint = (1 << (CURSE - NEW_CON_THRESHOLD));
    public static const CURSE_IMMUNE_BIT:uint = (1 << (CURSE_IMMUNE - NEW_CON_THRESHOLD));
    ...
    public static const ATT_BOOST_BIT:uint = (1 << (ATT_BOOST - NEW_CON_THRESHOLD));
    public static const DEF_BOOST_BIT:uint = (1 << (DEF_BOOST - NEW_CON_THRESHOLD));
    public static const SPD_BOOST_BIT:uint = (1 << (SPD_BOOST - NEW_CON_THRESHOLD));
    public static const VIT_BOOST_BIT:uint = (1 << (VIT_BOOST - NEW_CON_THRESHOLD));
    public static const WIS_BOOST_BIT:uint = (1 << (WIS_BOOST - NEW_CON_THRESHOLD));
    public static const DEX_BOOST_BIT:uint = (1 << (DEX_BOOST - NEW_CON_THRESHOLD));
    public static const SILENCED_BIT:uint = (1 << (SILENCED - NEW_CON_THRESHOLD));
    public static const EXPOSED_BIT:uint = (1 << (EXPOSED - NEW_CON_THRESHOLD));
    public static const ENERGIZED_BIT:uint = (1 << (ENERGIZED - NEW_CON_THRESHOLD));
            ...
            while (_local_3 < 32) {
                ...
                if (effects_[_local_3].iconOffsets_ != null) {
                    ...
                    while (_local_5 < effects_[_local_3].iconOffsets_.length) {
                        _local_6 = new BitmapData(16, 16, true, 0);
