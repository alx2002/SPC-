...
public class ObjectLibrary {
    ...
    public static function getItemIcon(_arg_1:int):BitmapData {
        ...
        var _local_2:XML = xmlLibrary_[_arg_1];
        var _local_4:BitmapData = getTextureFromType(_arg_1);
        var _local_8:TextureData = typeToTextureData_[_arg_1];
        var _local_10:BitmapData = ((_local_8) ? _local_8.mask_ : null);
        var _local_6:int = ((_local_2.hasOwnProperty("Tex1")) ? _local_2.Tex1 : 0);
        var _local_9:int = ((_local_2.hasOwnProperty("Tex2")) ? _local_2.Tex2 : 0);
        if (_arg_1 == -1) {
        ...
        if ((_local_6 != 0 || _local_9 != 0) && _arg_1 != 317 && _arg_1 != 318) {
            _local_4 = TextureRedrawer.retexture(_local_4, _local_10, _local_6, _local_9);
