...
internal class MEMap extends Sprite {
    ...
    public var regionMap_:BitmapData = new BitmapData(NUM_SQUARES, NUM_SQUARES, true, 0);
    public var map_:BitmapData = new BitmapData(SIZE, SIZE, true, 0);
    ...
    public function draw():void {
        ...
        if (this.ifShowRegionLayer_) {
            ...
            if (this.zoom_ > 2) {
                _local_4 = new BitmapData((SIZE / _local_3), (SIZE / _local_3));
