...
public class Camera {
    ...
    public function correctViewingArea(_arg_1:Boolean):Rectangle {
        ...
        if (Parameters.data_.stageScale == StageScaleMode.NO_SCALE) {
            ...
            _local_3 = (SPC.sWidth / _local_2);
            _local_4 = (SPC.sHeight / _local_2);
            _local_5 = (((!(Parameters.ssmode)) && (Parameters.data_.uiscale)) ? (((200 * SPC.sHeight) / 600) / _local_2) : (200 / _local_2));
            if (_arg_1) {
