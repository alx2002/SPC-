...
public class PetFeedStatsGrid extends UIGrid {
    ...
    private function createPlusLabels():void {
        ...
        while (_local_2 < 3) {
            ...
            DefaultLabelFormat.petStatLabelRight(_local_1, 6538829);
            _local_1.x = (195 + 8);
            _local_1.y = (_local_2 * 23);
            _local_1.visible = false;
            addChild(_local_1);
            this._plusLabels.push(_local_1);
            _local_2++;
        }
    }
    ...
    private function createLabels():void {
        ...
        DefaultLabelFormat.petStatLabelLeftSmall(_local_2, 0xA2A2A2);
        _local_2.text = "Ability";
        _local_2.y = -3;
        this._labelContainer.addChild(_local_2);
        _local_1 = new UILabel();
        DefaultLabelFormat.petStatLabelRightSmall(_local_1, 0xA2A2A2);
        _local_1.text = "Level";
        _local_1.x = ((195 - _local_1.width) + 4);
        _local_1.y = -3;
    ...
    private function renderAbility(_arg_1:AbilityVO, _arg_2:int):void {
        ...
        if (this.abilityBars.length > _arg_2) {
            ...
            _local_3 = new PetFeedProgressBar(195, 4, _arg_1.name, _local_4, ((!(_arg_1.getUnlocked())) ? 0 : _arg_1.points), _arg_1.level, this._maxLevel, 0x545454, 15306295, 6538829);
            ...
            _local_3.simulatedValueTextFormat = DefaultLabelFormat.createTextFormat(12, 6538829, "right", true);
