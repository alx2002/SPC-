...
public class DefaultLabelFormat {
    ...
    public static function createLabelFormat(_arg_1:UILabel, _arg_2:int = 12, _arg_3:Number = 0xFFFFFF, _arg_4:String = TextFormatAlign.LEFT, _arg_5:Boolean = false, _arg_6:Array = null):void {
    ...
    public static function defaultSmallPopupTitle(_arg_1:UILabel, _arg_2:String = TextFormatAlign.LEFT):void {
    ...
    public static function guildInfoLabel(_arg_1:UILabel, _arg_2:int = 14, _arg_3:Number = 0xFFFFFF, _arg_4:String = TextFormatAlign.LEFT):void {
    ...
    public static function coinsFieldLabel(_arg_1:UILabel):void {
        createLabelFormat(_arg_1, 18, 0xFFFFFF, TextAlign.RIGHT);
    }
    ...
    public static function deathFameCount(_arg_1:UILabel):void {
        createLabelFormat(_arg_1, 18, 0xFFC800, TextAlign.RIGHT, true);
    }

    public static function tierLevelLabel(_arg_1:UILabel, _arg_2:int = 12, _arg_3:Number = 0xFFFFFF, _arg_4:String = TextAlign.RIGHT):void {
    ...
    public static function questCompletedLabel(_arg_1:UILabel, _arg_2:Boolean, _arg_3:Boolean):void {
        var _local_4:Number = ((!(_arg_2)) ? 13224136 : 3971635);
    ...
    public static function petStatLabelRight(_arg_1:UILabel, _arg_2:uint, _arg_3:Boolean = false):void {
        createLabelFormat(_arg_1, 12, _arg_2, TextAlign.RIGHT, _arg_3);
    }
    ...
    public static function petStatLabelRightSmall(_arg_1:UILabel, _arg_2:uint, _arg_3:Boolean = false):void {
        createLabelFormat(_arg_1, 11, _arg_2, TextAlign.RIGHT, _arg_3);
    }
    ...
    public static function donateAmountLabel(_arg_1:UILabel):void {
        createLabelFormat(_arg_1, 18, 0xEAEAEA, TextAlign.RIGHT, false);
    }
