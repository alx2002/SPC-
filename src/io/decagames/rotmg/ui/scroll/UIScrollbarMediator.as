...
public class UIScrollbarMediator extends Mediator {
    ...
    override public function initialize():void {
        ...
        SPC.STAGE.addEventListener(MouseEvent.MOUSE_UP, this.onMouseUp);
    }
    ...
    override public function destroy():void {
        ...
        SPC.STAGE.removeEventListener(MouseEvent.MOUSE_UP, this.onMouseUp);
        this.view.dispose();
    }
    ...
    private function onUpdateHandler(_arg_1:Event):void {
        ...
        if (this.startDragging) {
            this.view.updatePosition((SPC.STAGE.mouseY - this.startY));
            this.startY = SPC.STAGE.mouseY;
        }
        this.view.update();
    }
